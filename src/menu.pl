...
% validate_size(+ArgumentsList)
% Validates the size of the board the user input.
...
% validate_players(+ArgumentsList)
% Validates the players the user input.
...
% change_players(-NewGameState)
% Runs the menu to change the players.
% In case of a fail, returns to the menu.
% A fail occurs when the user inputs 0.
change_players(menu) :-
...
% change_board_size(-NewGameState)
% Runs the menu to change the board size.
% In case of a fail, returns to the menu.
% A fail occurs when the user inputs 0.
...
% menu_option(+Option, -NewGameState)
% Handles the option the user input.
